...
var _ = Describe("Transport", func() {
	...
	Describe("CHILDREN", func() {
		...
		Describe("GET", func() {
			...
			var (
				jsonChildRef = `{"id": "childid-1","daycareId": "namek","firstName": "Goten","lastName": "Goten","birthDate": "1992-10-13 00:00:00 +0000 UTC","gender": "M","imageUri": "gs://foo/bar.jpg","startDate": "2018-03-28 00:00:00 +0000 UTC","notes": "some special notes","allergies": ["tomato"],"specialInstructions": ["this boy always sleeps please keep him awaken"]}`
			)
		...
		Describe("UPDATE", func() {
			...
			var (
				jsonUpdatedChild = `{"id": "childid-1","daycareId": "namek", "firstName": "Goten","lastName": "Goten","birthDate": "1992-10-14 00:00:00 +0000 UTC","startDate":"2018-03-28 00:00:00 +0000 UTC", "gender": "M","imageUri": "gs://foo/bar.jpg","notes": "updated notes", "allergies": ["tomato"], "specialInstructions": ["another special instruction"]}`
			)
		...
		Describe("CREATE", func() {
			...
			var (
				jsonCreatedChild = `{ "id": "aaa", "daycareId": "peyredragon", "firstName": "Rickon", "lastName": "Stark", "birthDate": "1992-10-14 00:00:00 +0000 UTC", "gender": "M", "imageUri": "gs://foo/bar.jpg", "startDate": "2018-03-28 00:00:00 +0000 UTC", "notes": "he hates yogurt", "allergies": [ "tomato" ], "responsibleId": "id4", "specialInstructions": [ "vegetarian" ] }`
			)
			...
			BeforeEach(func() {
				...
				httpEndpointToUse = "/children"
				httpBodyToUse = `{"daycareId": "peyredragon", "notes": "he hates yogurt", "specialInstructions": ["vegetarian"], "relationShip": "mother", "allergies": ["tomato"], "responsibleId": "id4", "firstName": "Rickon", "lastName": "Stark", "gender": "M", "birthDate": "1992/10/14", "startDate":"2018/03/28", "imageUri": "data:image/jpeg;base64,"}`
			})

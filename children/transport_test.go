...
var _ = Describe("Transport", func() {
	...
	BeforeEach(func() {
		...
		concreteStore.Db.Exec(`INSERT INTO "children" ("child_id","first_name","last_name","birth_date","start_date","gender","image_uri","notes") VALUES ('childid-1','Arthur','Gustin','1992-10-13T00:00:00Z','2018-03-28T00:00:00Z','M','gs://foo/bar.jpg', 'some special notes')`)
	...
	Describe("CHILDREN", func() {
		...
		Describe("GET", func() {
			...
			var (
				jsonChildRef = `{"id": "childid-1","firstName": "Arthur","lastName": "Gustin","birthDate": "1992-10-13 00:00:00 +0000 UTC","startDate": "2018-03-28 00:00:00 +0000 UTC","gender": "M","imageUri": "gs://foo/bar.jpg","notes": "some special notes", "allergies": ["tomato"], "specialInstructions": ["this boy always sleeps please keep him awaken"]}`
			)
		...
		Describe("UPDATE", func() {
			...
			var (
				jsonUpdatedChild = `{"id": "childid-1","firstName": "Arthur","lastName": "Gustin","birthDate": "1992-10-14 00:00:00 +0000 UTC","startDate":"2018-03-28 00:00:00 +0000 UTC", "gender": "M","imageUri": "gs://foo/bar.jpg","notes": "updated notes", "allergies": ["tomato"], "specialInstructions": ["another special instruction"]}`
			)
		...
		Describe("CREATE", func() {
			...
			var (
				jsonCreatedChild = `{"specialInstructions": ["vegetarian"], "responsibleId": "id5", "id": "aaa","firstName": "Arthur","lastName": "Gustin","birthDate": "1992-10-14 00:00:00 +0000 UTC","startDate":"2018-03-28 00:00:00 +0000 UTC", "gender": "M","imageUri": "gs://foo/bar.jpg", "notes": "he hates yogurt", "allergies": ["tomato"]}`
			)
